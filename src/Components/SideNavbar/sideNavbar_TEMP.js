    ...
    >
      ...
      <div className="home_sideNavbarMiddle">
        ...
        <div className="home_sideNavbarTopOption">
          <img
            className="home_sideNavbar_ImgLogo"
            src="https://i.pinimg.com/736x/8b/12/52/8b125232501ef2f169a7085149b14a3b.jpg"
            alt=""
          />
        ...
        <div className="home_sideNavbarTopOption">
          <img
            className="home_sideNavbar_ImgLogo"
            src="https://yt3.googleusercontent.com/J1leGk1XpHFz2r1WrwBCjJWtZ9Y4-qHPHm4Vkl81bm8vZhTkCdj9GHPUibuWFnDIX5HB8LTj=s900-c-k-c0x00ffffff-no-rj"
            alt=""
          />
